    ...
    <div class="m-content-table">
          ...
          <table id="tbdlEmloyeesList" class="m-table">
            <thead>
              <tr>
                ...
                <th class="text-align-left" style="width: 125px">Mã tài sản</th>
                ...
                <th class="text-align-right" style="width: 100px">Số lượng</th>
      ...
      <div class="m-paging">
            <div class="m-paging-left">
              ...
              <select
                class="m-combobox combobox-count"
                name=""
                id="cbxPageSize"
              >
              ...
              <div class="m-paging-number">
                <div class="m-paging-hover page-number page-number-active">
                  1
                </div>
